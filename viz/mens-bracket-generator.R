...
text(9.8,64.75,submission$TeamName[which(submission$Seed == 1 & submission$Region == "X")],cex=.7) #1st seed
text(9.8,62.75, submission$TeamName[which(submission$Seed == 16 & submission$Region == "X" & submission$Round1 > 0.5)],cex = .7) #submission$TeamName[which(submission$Seed == 16 & submission$Region == "X")],cex=.7) #16th seed
text(9.8,60.75,submission$TeamName[which(submission$Seed == 8 & submission$Region == "X")],cex=.7)
text(9.8,58.75,submission$TeamName[which(submission$Seed == 9 & submission$Region == "X")],cex=.7)
text(9.8,56.75,submission$TeamName[which(submission$Seed == 5 & submission$Region == "X")],cex=.7)
text(9.8,54.75,submission$TeamName[which(submission$Seed == 12 & submission$Region == "X")],cex=.7)
text(9.8,52.75,submission$TeamName[which(submission$Seed == 4 & submission$Region == "X")],cex=.7)
text(9.8,50.75,submission$TeamName[which(submission$Seed == 13 & submission$Region == "X")],cex=.7)
text(9.8,48.75,submission$TeamName[which(submission$Seed == 6 & submission$Region == "X")],cex=.7)
text(9.8,46.75, submission$TeamName[which(submission$Seed == 11 & submission$Region == "X" & submission$Round1 > 0.5)] , cex = .7)#submission$TeamName[which(submission$Seed == 11 & submission$Region == "X")],cex=.7)
text(9.8,44.75,submission$TeamName[which(submission$Seed == 3 & submission$Region == "X")],cex=.7)
text(9.8,42.75,submission$TeamName[which(submission$Seed == 14 & submission$Region == "X")],cex=.7)
text(9.8,40.75,submission$TeamName[which(submission$Seed == 7 & submission$Region == "X")],cex=.7)
text(9.8,38.75,submission$TeamName[which(submission$Seed == 10 & submission$Region == "X")],cex=.7)
text(9.8,36.75,submission$TeamName[which(submission$Seed == 2 & submission$Region == "X")],cex=.7)
text(9.8,34.75,submission$TeamName[which(submission$Seed == 15 & submission$Region == "X")],cex=.7) # 15th seed


# Round 32, top left (Region X)
## Determine winners/probabilities from 1st round and carry forward
top_left_1_16_winner <- round((submission %>% filter(Region == "X" & Seed %in% c(1,16)) %>% top_n(1,wt = Round2) %>% select(Round2))$Round2*100,0)
top_left_8_9_winner  <- (submission %>% filter(Region == "X" & Seed %in% c(8,9)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
top_left_5_12_winner <- (submission %>% filter(Region == "X" & Seed %in% c(5,12)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
top_left_4_13_winner <- (submission %>% filter(Region == "X" & Seed %in% c(4,13)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
top_left_6_11_winner <- (submission %>% filter(Region == "X" & Seed %in% c(6,11)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
top_left_3_14_winner <- (submission %>% filter(Region == "X" & Seed %in% c(3,14)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
top_left_7_10_winner <- (submission %>% filter(Region == "X" & Seed %in% c(7,10)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
top_left_2_15_winner <- (submission %>% filter(Region == "X" & Seed %in% c(2,15)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
## Write it out
...
## Determine winners/probabilities from 1st round and carry forward
top_left_s16_1_winner <- round((submission %>% filter(Region == "X" & Seed %in% c(1,16,8,9)) %>% top_n(1,wt = Sweet16) %>% select(Sweet16))$Sweet16*100,0)
top_left_s16_2_winner <- (submission %>% filter(Region == "X" & Seed %in% c(5,12,4,13)) %>% top_n(1,wt = Sweet16) %>% select(TeamName))$TeamName
top_left_s16_3_winner <-  (submission %>% filter(Region == "X" & Seed %in% c(6,11,3,14)) %>% top_n(1,wt = Sweet16) %>% select(TeamName))$TeamName
top_left_s16_4_winner <-  (submission %>% filter(Region == "X" & Seed %in% c(7,10,2,15)) %>% top_n(1,wt = Sweet16) %>% select(TeamName))$TeamName
...
top_left_e8_1_winner <- round((submission %>% filter(Region == "X" & Seed %in% c(1,16,8,9,5,12,4,13)) %>% top_n(1,wt = Elite8) %>% select(Elite8))$Elite8*100,0)
top_left_e8_2_winner <- (submission %>% filter(Region == "X" & Seed %in% c(6,11,3,14,7,10,2,15)) %>% top_n(1,wt = Elite8) %>% select(TeamName))$TeamName
...
text(9.8,30.75,submission$TeamName[which(submission$Seed == 1 & submission$Region == "W")],cex=.7) 
text(9.8,28.75,submission$TeamName[which(submission$Seed == 16 & submission$Region == "W" & submission$Round1 > 0.5)],cex=.7)
...
text(9.8,12.75,submission$TeamName[which(submission$Seed == 11 & submission$Region == "W" & submission$Round1 > 0.5)],cex = .7) #submission$TeamName[which(submission$Seed == 11 & submission$Region == "W")],cex=.7) ## Play in
text(9.8,10.75,submission$TeamName[which(submission$Seed == 3 & submission$Region == "W")],cex=.7)
text(9.8, 8.75, submission$TeamName[which(submission$Seed == 14 & submission$Region == "W")],cex=.7)
text(9.8, 6.75, submission$TeamName[which(submission$Seed == 7 & submission$Region == "W")],cex=.7)
text(9.8, 4.75, submission$TeamName[which(submission$Seed == 10 & submission$Region == "W")],cex=.7)
text(9.8, 2.75, submission$TeamName[which(submission$Seed == 2 & submission$Region == "W")],cex=.7)
text(9.8, 0.75, submission$TeamName[which(submission$Seed == 15 & submission$Region == "W")],cex=.7)


# Round 32, bottom left (Region W) 
## Determine winners/probabilities from 1st round and carry forward
bottom_left_1_16_winner <- round((submission %>% filter(Region == "W" & Seed %in% c(1,16)) %>% top_n(1,wt = Round2) %>% select(Round2))$Round2*100,0)
bottom_left_2_15_winner <- (submission %>% filter(Region == "W" & Seed %in% c(2,15)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
bottom_left_8_9_winner  <- (submission %>% filter(Region == "W" & Seed %in% c(8,9)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
bottom_left_5_12_winner <- (submission %>% filter(Region == "W" & Seed %in% c(5,12)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
bottom_left_4_13_winner <- (submission %>% filter(Region == "W" & Seed %in% c(4,13)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
bottom_left_6_11_winner <- (submission %>% filter(Region == "W" & Seed %in% c(6,11)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
bottom_left_3_14_winner <- (submission %>% filter(Region == "W" & Seed %in% c(3,14)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
bottom_left_7_10_winner <- (submission %>% filter(Region == "W" & Seed %in% c(7,10)) %>% top_n(1,wt = Round2) %>% select(TeamName))$TeamName
## Write it out
...
## Determine winners/probabilities from 1st round and carry forward
bottom_left_s16_1_winner <- round((submission %>% filter(Region == "W" & Seed %in% c(1,8,9,16)) %>% top_n(1,wt = Sweet16) %>% select(Sweet16))$Sweet16*100,0)
bottom_left_s16_2_winner <-  (submission %>% filter(Region == "W" & Seed %in% c(5,12,4,13)) %>% top_n(1,wt = Sweet16) %>% select(TeamName))$TeamName
bottom_left_s16_3_winner <-  (submission %>% filter(Region == "W" & Seed %in% c(6,11,3,14)) %>% top_n(1,wt = Sweet16) %>% select(TeamName))$TeamName
bottom_left_s16_4_winner <- (submission %>% filter(Region == "W" & Seed %in% c(2,15,7,10)) %>% top_n(1,wt = Sweet16) %>% select(TeamName))$TeamName
...
## Determine winners/probabilities from Sweet 16 and carry forward
bottom_left_e8_1_winner <- round((submission %>% filter(Region == "W" & Seed %in% c(1,16,8,9,5,12,4,13)) %>% top_n(1,wt = Elite8) %>% select(Elite8))$Elite8*100,0)
bottom_left_e8_2_winner <- (submission %>% filter(Region == "W" & Seed %in% c(2,15,7,10,6,11,3,14)) %>% top_n(1,wt = Elite8) %>% select(TeamName))$TeamName
...
top_left_final_four <- round((submission %>% filter(Region == "X") %>% top_n(1,wt = Final4) %>% select(Final4))$Final4*100,0)
bottom_left_final_four <- round((submission %>% filter(Region == "W") %>% top_n(1,wt = Final4) %>% select(Final4))$Final4*100,0)
